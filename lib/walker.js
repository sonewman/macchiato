...
Walker.prototype.newDescribe = function newDesc(runner, scheduler) {
  var walker = this
  ...
  function describe() {
    ...
    return new Chain(test, walker.options)
  }
...
//  var grep = this.__options__.grep
//  if (grep) {
//    
//  }
